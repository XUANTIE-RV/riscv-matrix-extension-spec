[[header]]
:description: Matrix Multiplication Extension Intrinsic API Reference Manual
:company: T-head-Semi
:revdate: 4/2024
:revnumber: 0.2
...
= Matrix Multiplication Extension Intrinsic API Reference Manual
...
Copyright 2022 by T-Head Semiconductor Corp.

[preface]
include::contributors.adoc[]

include::rvm-intrinsic-api.adoc[]
